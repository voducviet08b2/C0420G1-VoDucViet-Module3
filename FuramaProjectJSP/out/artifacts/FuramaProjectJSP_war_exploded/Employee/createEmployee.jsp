            ...
            <div class="col-11">
                ...
                <form action="/employeeServlet" method="get">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" title="Chữ cái đầu viết hoa" pattern="([A-Z]([a-z])* ?)+" name="hoTen" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="">Ngày sinh </label>
                        <input type="text" name="ngaySinh" placeholder="YYYY-MM-dd" pattern="(19[0-9][0-9])|(20(00|01|02)-[0-9]{2}-[0-9]{2}" name="ngaySinh" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="">Số CMND</label>
                        <input type="text" pattern="(\d{9}|\d{12})" title="CMND không đúng định dạng" name="soCMND" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="">Lương</label>
                        <input type="text" name="luong" title="Lương lớn hơn 0" pattern="[1-9]\d*" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="">Số điện thoại</label>
                        <input type="text" pattern="(090|091)[\d]{7}" title="Số điện thoại sai định dạng" name="sdt" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="">Email</label>
                        <input type="text" pattern="[a-zA-Z0-9]+@[a-zA-Z0-9]+(\.[a-zA-Z0-9]+)" title="Email không đúng định dạng" name="email" class="form-control">
                    </div>
                    <div class="form-group">
