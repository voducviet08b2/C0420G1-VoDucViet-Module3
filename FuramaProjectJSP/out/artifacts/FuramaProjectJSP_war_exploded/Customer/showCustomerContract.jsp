        ...
        <div class="col-11">
            <table class="table table-striped">
                ...
                <tr class="contentPage">
                    ...
                    <td><c:out value="${show.hoTen}"></c:out></td>
                    <td><c:out value="${show.ngayLamHopDong}"></c:out></td>
                    <td><c:out value="${show.tenDichVuDiKem}"></c:out></td>
                    <td><c:out value="${show.tenDichVu}"></c:out></td>
