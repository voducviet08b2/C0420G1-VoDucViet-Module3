        ...
        <div class="col-11">
            ...
            <form action="/customerServlet" method="get">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="ngaySinh" class="form-control"  value="${ngaySinh}">
                </div>
                <div class="form-group">
                    <label for="">Số CMND</label>
                    <input type="text" name="soCMND" value="${soCMND}"  class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="idLoaiKhach">
                        <c:forEach var="customerType" items="${customerTypeList}">
                            <option value="${customerType.id}" ><c:out value="${customerType.tenLoaiKhach}"></c:out></option>
                        </c:forEach>
                    </select>
                </div>
